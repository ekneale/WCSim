...
G4double* EljenEJ286::GetAbs() {
  static G4double AbsPlate[nEntries_abslength_eljen] = {
	...
	//0.535687*cm, 0.436663*cm, 0.359206*cm, 1.21309*cm, 0.25258*cm, 0.218972*cm, 0.19729*cm, 0.185792*cm, 0.180695*cm, 0.178475*cm,
...
void EljenEJ286::SetgAbs(){
  ...
  for(int i=nEntries_abslength_eljen-1; i>0; i--){
    ...
    //    std::cerr << "CPFLAG " << round(hWL(GetPhotonEnergy_ABS()[i]))*nm << "nm -> " << (1. - exp(-1.2*cm/GetAbs()[i])) << std::endl;
  }
