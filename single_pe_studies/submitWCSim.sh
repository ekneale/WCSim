...
DATA_DIR=$BASE_DATA_DIR/single_pe_studies/
...
WCSim full_diffuse_fibres.mac

root -l -x -b -q 'ReduceODOutput.C("/scratch/user/full_diffuse_n10000_1000ev.root","/scratch/user/reduced_full_diffuse_n10000_1000ev.root")'



rm /scratch/user/full_diffuse_n10000_1000ev.root
mv /scratch/user/reduced_full_diffuse_n10000_1000ev.root $DATA_DIR
