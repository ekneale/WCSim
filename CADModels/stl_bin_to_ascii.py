# credit to IsseiMori on GitHub

# -*- encoding: utf-8 -*-
import struct

infile = open('WholeModel.Upper4Rows-NoDome.dwg.ipt.stl') #import file
out = open('WholeModel.Upper4Rows-NoDome_ascii.stl', 'w') #export file

data = infile.read()

out.write("solid cadmesh ")
